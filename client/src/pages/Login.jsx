      ...
      <div className='grid grid-cols-3 h-full'>
        ...
        <div className='px-20 relative bg-stone-200 col-span-2 flex items-center'>
          ...
          <div className='absolute top-8 right-8 text-sm flex items-center space-x-4'>
            ...
            <Link className=' rounded-md px-4 py-2 ring-1 ring-stone-500 hover:bg-stone-900 hover:text-white transition-all duration-200 ease-in-out' to={"/register"}>Register</Link>
          </div>
        </div>
      </div>
    </div>
