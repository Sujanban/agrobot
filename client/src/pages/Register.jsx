  ...
  return (
    <div className='h-screen'>
      <div className='grid grid-cols-3 h-full'>
        ...
        <div className='relative bg-stone-200 col-span-2 flex items-center justify-center'>
          <div className='px-8 max-w-md py-12 bg-whsssssite rounded-xl shadow-xl border'>
