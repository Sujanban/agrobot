...
const Tesimonial = () => {
    return (
        <section className='bg-slate-100'>
            <div className='px-4 py-20 max-w-7xl mx-auto space-y-4 '>
                ...
                <div className='p-8 grid grid-cols-2'>
                    ...
                    <div className='space-y-4 flex flex-col'>
                        <div className='p-4 testimonial-banner space-y-2 grow'>
                            ...
                            <h1 className='text-3xl font-medium '>I was amaized by the level of assistance received from the AI Chatbot provided by Agrobot. It quickly undeerstood my needs and provided me with the best possible solutions.</h1>
                        </div>
                        <div className='p-4 border-t-2 border-slate-300 flex justify-between items-center'>
                            ...
                            <button className='font-thin border rounded-full px-8 py-2 text-white bg-black'>See more testimonials</button>
                        </div>
                    </div>
                </div>
            </div>
